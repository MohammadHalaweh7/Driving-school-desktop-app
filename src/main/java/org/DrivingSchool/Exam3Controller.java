...
public class Exam3Controller
{
    ...
    public void Next(ActionEvent event) throws IOException {
        ...
        FXMLLoader root = new FXMLLoader(getClass().getResource("/FXML/Exam4.fxml"));
        Stage parent = root.load();
        stage.setScene(parent.getScene());
        Exam3Controller exam3Controller = root.getController();
        exam3Controller.count = count;
    ...
    public void HomeExam3(ActionEvent event)throws IOException
    {
    ...
    public void DrivingCourseExam3(ActionEvent event)throws IOException
    {
    ...
    public void SignsAndSignalsExam3(ActionEvent event)throws IOException
    {
    ...
    public void RoadSafetyExam3(ActionEvent event)throws IOException
    {
    ...
    public void ExamsExam3(ActionEvent event)throws IOException
    {
    ...
    public void LogOutExam3(ActionEvent event)throws IOException
    {
