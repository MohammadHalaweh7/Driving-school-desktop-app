...

{
    ...
    public void HomeExam4(ActionEvent event)throws IOException
    {
    ...
    public void DrivingCourseExam4(ActionEvent event)throws IOException
    {
    ...
    public void SignsAndSignalsExam4(ActionEvent event)throws IOException
    {
    ...
    public void RoadSafetyExam4(ActionEvent event)throws IOException
    {
    ...
    public void ExamsExam4(ActionEvent event)throws IOException
    {
    ...
    public void LogOutExam4(ActionEvent event)throws IOException
    {
